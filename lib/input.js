...
proto._readObject = function () {
  ...
  if (la === cons.TC_OBJECT) {
    ...
    throw new Error('[_readContent] Illegal lookahead: ' + la.toString(16));
  }
};
...
proto._readNewObject = function () {
  ...
  debug('[_readNewObject] << got %j', $class.name);
...
proto._readNewClassDesc = function () {
  ...
  var la = this.lookAhead();
  debug('[_readNewClassDesc] >> lookahead: 0x' + la.toString(16));
  ...
  if (la === cons.TC_CLASSDESC) {
    ...
    debug('[_readNewClassDesc] << got: %j', obj);
    return obj;
    ...
    throw new Error('[_readNewClassDesc] Illegal lookahead: 0x' + la.toString(16));
  }
};
...
proto._readPrevObject = function () {
  ...
  debug('[_readRrevObject] << %d : %j', ref, obj);
  return obj;
};
...
proto._readClassDesc = function () {
  ...
  var la = this.lookAhead();
  debug('[_readClassDesc] >> lookahead: 0x' + la.toString(16));
  ...
  if (la === cons.TC_CLASSDESC) {
    ...
    throw new Error('[_readClassDesc] Illegal lookahead: 0x' + la.toString(16));
  }
};
...
proto._readNowrclass = function (obj) {
  debug('[_readNowrclass] >> %d fields', obj.$fields.length);
  // nowrclass:
